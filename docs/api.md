# API Summary — v0.13.x (latest) (/reference/api)
...
| `SDK_NOT_FOUND_IN_NODE_MODULES`   | 50600 | QVAC SDK not found in node\_modules. Checked: @qvac/sdk, @tetherto/sdk-mono, @tetherto/sdk-dev                                                                                                                                                                                                                                                                                    |
